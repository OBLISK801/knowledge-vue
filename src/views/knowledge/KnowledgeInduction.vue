    ...
    <el-card>
      <el-form label-width="80" :model="tinymceData" :rules="tinymceDataRules">
        <el-row :gutter="4" style="margin-bottom: 10px;">
          <span style="font-size: 18px; font-weight: bold; margin-right: 30px;">笔记分类:</span>
          <el-cascader
            style="width: 300px;"
          ...
          <span style="font-size: 18px; font-weight: bold; margin-right: 30px; margin-left: 30px;">笔记标签:</span>
        ...
        <el-row :gutter="4">
          <el-col :span="2">
            <el-form-item>
              <span style="font-size: 18px; font-weight: bold">笔记标题:</span>
            </el-form-item>
          </el-col>
          <el-col :span="22">
        ...
        <el-row :gutter="4">
          <el-col :span="2">
            <el-form-item>
              <span style="font-size: 18px; font-weight: bold">笔记摘要:</span>
            </el-form-item>
          </el-col>
          <el-col :span="22">
