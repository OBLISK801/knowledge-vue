    ...
    <el-card>
      <el-form label-width="80" :model="tinymceData" :rules="tinymceDataRules">
        <el-row :gutter="4" style="margin-bottom: 10px;">
          ...
          <el-button type="info" @click="handleAdd()" style="margin-left: 5px;" size="small">新增标签</el-button>
          <el-button type="primary" @click="complete(1)" style="float: right;" size="small">发布文章</el-button>
          <el-button type="success" @click="complete(0)" style="float: right;" size="small">保存文章</el-button>
          <el-button type="warning" @click="save" style="float: right;" size="small">暂存文章</el-button>
        </el-row>
        <el-row :gutter="4">
          <el-col :span="2">
            <el-form-item>
